        ...
        combineActivities: function (activities) {
            ...
            _.each(activities, function (activity) {
                ...
                if (activity.type === 'Ride') {
                    ...
                    note += "\nAscend " + Math.round(activity.total_elevation_gain) + "m, time ";
                    ...
                    var note2 = activity.type + ": " + distance + "km " + activity.name;
                    note2 += ", moving time " + self.formatHMS(activity.moving_time, {seconds: false});
                    if (activity.description) {
                        note2 += "\n" + activity.description;
                    }
                    if (entry.note0) {
