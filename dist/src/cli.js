...
function run() {
    ...
    return Promise.resolve()
        ...
        let opts = {
            ...
            dates: program.dates || [],
            more: program.more,
            kml: program.path && program.kml ? path_1.default.resolve(program.path, program.kml) : program.kml,
            xml: program.path && program.xml ? path_1.default.resolve(program.path, program.xml) : program.xml,
